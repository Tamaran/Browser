========================================================================
    STATISCHE BIBLIOTHEK: RequestEngine-Projektübersicht
========================================================================

Dieses RequestEngine-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre RequestEngine-Anwendung besteht.


RequestEngine.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "RequestEngine.pch und eine 
