========================================================================
    STATISCHE BIBLIOTHEK: Dom-Projektübersicht
========================================================================

Dieses Dom-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Dom-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Dom.pch und eine 
